...
hora =[
    int(input("Diga o horario atual "))
]
chave =[ 
    input("A chave está ativa? ").lower()
]
...
# Ele vai verificar o operador [elemento] na [list]
for elemento in ListaCargo:
    ...
    if cargo == elemento:
         if( chave == "sim") or (cargo == "supervisor")\
             or hora in ListaHorario:
                 print("1") 
